...
# Dataset (choose one).
desc += '-celebahq';            dataset = EasyDict(tfrecord_dir='flickr'); train.mirror_augment = True
...
#desc += '-preset-v2-1gpu'; num_gpus = 2; sched.minibatch_base = 4; sched.minibatch_dict = {4: 16, 8: 16, 16: 16, 32: 16, 64: 16, 128: 8, 256: 8, 512: 4}; sched.G_lrate_dict = {1024: 0.0015}; sched.D_lrate_dict = EasyDict(sched.G_lrate_dict); train.total_kimg = 6000 #12000 {4: 128, 8: 128, 16: 128, 32: 64, 64: 32, 128: 16, 256: 8, 512: 4}
desc += '-preset-v2-2gpus'; num_gpus = 2; sched.minibatch_base = 4; sched.minibatch_dict = {4: 16, 8: 16, 16: 16, 32: 16, 64: 16, 128: 8, 256: 8, 512: 4, 1024: 2}; sched.G_lrate_dict = {512: 0.0015, 1024: 0.002}; sched.D_lrate_dict = EasyDict(sched.G_lrate_dict); train.total_kimg = 6000
...
desc += '-fp32'; sched.max_minibatch_per_gpu = {256: 16, 512: 8, 1024: 2} #1024 4
...
train = EasyDict(func='util_scripts.generate_fake_images', run_id=12, num_pngs=1000); desc = 'fake-images-' + str(train.run_id)
...
#train = EasyDict(func='util_scripts.generate_interpolation_video', run_id=0, grid_size=[1,1], duration_sec=360.0, smoothing_sec=1.0); num_gpus = 1; desc = 'interpolation-video-' + str(train.run_id)
